...
def pdf_katalog_erzeugen(df):
    ...
    story.append(
        Paragraph(
            "Kunstbild-Datenbank – Werkverzeichnis",
            titel_style,
        )
    )
    ...
    for index, row in df.iterrows():
        ...
        if beschreibung:
            story.append(
                Paragraph(
                    f"<b>Beschreibung:</b><br/>{beschreibung}",
                    text_style,
                )
            )
